...
export const FAQ_DATA = [
  ...
  { id: "faq-4", question: "È necessario prendere appuntamento?", answer: "No, Natural Wash Pets è un servizio self-service 100% autonomo. Potete venire quando preferite durante gli orari di apertura (08:30 - 20:30). L'accesso è controllato da un sistema apriporta temporizzato." },
