...
export const CookieBanner: React.FC<CookieBannerProps> = ({ accepted, onAccept, onReject, onOpenPrefs }) => {
      ...
      <div className="bg-white dark:bg-zinc-900 w-full max-w-4xl rounded-[2rem] shadow-2xl border border-natural-100 dark:border-zinc-800 p-6 sm:p-8 relative">
        ...
        <div className="space-y-6">
          ...
          <p className="text-natural-600 dark:text-natural-400 text-sm leading-relaxed">
            ...
            Per maggiori dettagli consulta la nostra <button onClick={onOpenPrefs} className="text-natural-500 underline font-bold">Cookie Policy</button>.
          </p>
